...
public class TreapTest {
    ...
    void test1() {
        ...
        assertTrue(testTree.add(5,71));
        assertTrue(testTree.add(7,72));
        assertTrue(testTree.add(2,34));
        assertTrue(testTree.add(6,16));
        assertTrue(testTree.add(4,53));
        assertTrue(testTree.add(1,45));
